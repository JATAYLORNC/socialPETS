               ...
               <div className="row"> 
                <div className="col-sm-12">
                  <form className="commentForm" onSubmit={this.onCommentSubmit}>
                      ...
                      <div>
                          <textarea rows="1" className="text w-100" onChange={this.handleInputChange} name="Comments" placeholder="Write a comment..."></textarea>
                      </div>

                    <button type="submit" className="btn btn-primary" onClick={this.onCommentSubmit} >Submit</button>
